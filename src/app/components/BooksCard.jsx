...
const BooksCard = ({ data }) => {
    ...
    return (
        <div className="card bg-[#071117] overflow-hidden shadow-md hover:shadow-green-300/20 transition-all duration-300">
            <figure className="h-90 lg:h-90 w-full overflow-hidden">
            ...
            <div className="lg:card-body lg:p-6 md:space-y-4">
                <h2 className="card-title lg:text-3xl">{data.title}</h2>
